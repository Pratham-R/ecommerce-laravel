          ...
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                ...
                <div class="h5 mb-0 font-weight-bold text-gray-800">{{\App\Models\Product::where('is_approved', false)->count()}}</div>
              </div>
              <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <a href="{{ route('admin.products.pending') }}" class="btn btn-warning btn-block">
                                <i class="fas fa-clock"></i> View Pending Products
                            </a>
                        </div>
                        <div class="col-md-6 mb-3">
                            <a href="{{ route('admin.sellers.index') }}" class="btn btn-info btn-block">
